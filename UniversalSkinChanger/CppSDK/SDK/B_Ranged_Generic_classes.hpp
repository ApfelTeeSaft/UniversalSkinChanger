...
public:
	...
	bool                                          Scope_Minus_Render_Enemies_To_Custom_Depth_Buffer; // 0x0CB0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn)
...
static_assert(offsetof(AB_Ranged_Generic_C, Scope_Minus_Render_Enemies_To_Custom_Depth_Buffer) == 0x000CB0, "Member 'AB_Ranged_Generic_C::Scope_Minus_Render_Enemies_To_Custom_Depth_Buffer' has a wrong offset!");
